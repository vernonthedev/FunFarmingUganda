...
<p class="s-text s-text--on-dark">
    For fantastic team-building events, bachelor/bachelorette parties, and Ugandan hospitality, you're at the right place on the farm of Fun Farm Uganda
        ...
        <div class="u-slant-top-reversed u-mb-neg-slant-height u-bg-alt--500">
            <div class="  o-component-area__component">
                <div class="o-usp-row  o-usp-row--blue-background" data-kal="slide-up">
...
<div class="o-component-area  u-slant-top u-mb-neg-slant-height">
 <h1 align="center" style="padding-top: 5px; margin-top: 30px; font-weight: bold;" class="o-personal__title">Fun Farming Team</h1>
    ...
    <div class="o-personal  u-spacing-pb10">
        ...
        <div class="o-personal__deco-left">
        ...
        <div class="o-personal__main">
            ...
            <div class="o-personal__image">
                <img alt="cta person" src="img/webimgs/david-holding-goat.jpg" />
            </div>

            <div class="o-personal__content">
                <div class="o-personal__title">Project Manager</div>
                <div class="o-personal__subtitle">Mitala David</div>

                <ul class="o-personal__methods">

                    <li class="o-personal__method">
                        <a class="o-personal__link" href="tel:+256772826680">
                            <i>
                            ...
                            <span>+256 700 462 477</span>
                        </a>
                    </li>

                    <li class="o-personal__method">
                        <a class="o-personal__link" href="mailto:">
                            <i>
                                <svg width="15" height="15">
                                    <use href="img/icon-mail.svg#mail"></use>
                                </svg>
                            </i>

                            <span>info@funfarminug.org</span>
                        </a>
                    </li>
        ...
        <div class="o-personal__deco-right">
...
<div class="o-personal__content">
    <div class="o-personal__title">Managing Director</div>
    <div class="o-personal__subtitle">Meddy</div>
