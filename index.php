                                ...
                                <div class="c-video">
                                    <div class="c-video__placeholder">
                                        <div
                                            class="c-video__iframe  js-youtube-player"
                                            loading="lazy"
                                            data-youtube-link="6hq7RGeBr60"
                                            data-auto-play="1"
                                            data-disable-kb=""
                                            data-controls="1"
                                            data-loop="0"
                                            id="componentable-area-2-video"
                                        ></div>
                                    </div>
                                </div>
                            </div>
    ...
    "Who is Cow-rupted" is a fun and interactive program set in a farm-themed environment, offering various games and opportunities to connect with each other. It's perfect for an enjoyable evening or after-work program!
        ...
        <div class="l-double  l-double--wide   u-spacing-pt6">
            <div class="l-double__left">
                                <img class="is-kal-end" loading="lazy" data-kal="slide-right" src="uploads/component-uploads/komma-activiteiten-pagina-wig-036354500-1693483306_medium.png" alt="FarmFun activiteiten ">
                        </div>
                                ...
                                <div class="c-video">
                                    <div class="c-video__placeholder">
                                        <div
                                            class="c-video__iframe  js-youtube-player"
                                            loading="lazy"
                                            data-youtube-link="GH-fVkWn2fU"
                                            data-auto-play="1"
                                            data-disable-kb=""
                                            data-controls="1"
                                            data-loop="0"
                                            id="componentable-area-4-video"
                                        ></div>
                                    </div>
                                </div>
                            </div>
